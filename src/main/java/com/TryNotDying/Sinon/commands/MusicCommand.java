 ...
 * Below is the music command class
 */
public abstract class MusicCommand extends SlashCommand {
    ...
    protected void execute(CommandEvent event) {
        ...
        // Check if the user has the verified member role
        List<Role> roles = member.getRoles();
        for (Role role : roles) {
            if (role.getIdLong() == bot.getConfig().getVerifiedMemberRoleId()) {
        ...
        // If the user doesn't have the verified member role, send an error embed.
