...
public class sinon 
{
    ...
    private static void startBot()
    {
        ...
        try
        {
            ...
            {
                LOG.info("Sinon", "You currently have a custom prefix set. "
        ...
        {
            prompt.alert(Prompt.Level.ERROR, "Sinon", "Some aspect of the configuration is "
                    + "invalid: " + ex + "\nConfig Location: " + config.getConfigLocation());
            System.exit(1);
        }
    ...
    private static CommandClient createCommandClient(BotConfig config, SettingsManager settings, Bot bot)
    {
        ...
        AboutCommand aboutCommand = new AboutCommand(Color.BLUE.brighter(),
                                "a music bot that is [the shit!](https://github.com/TryNotDying/Sinon/) (v" + OtherUtil.getCurrentVersion() + ")",
